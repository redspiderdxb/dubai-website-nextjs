(function ($) {
  ...
  function initAllSwipers() {
    ...
    initSwiperSafe(".happSwiper", {
      ...
      pagination: {
        el: ".happSwiper .swiper-pagination",
        clickable: true,
      },
      breakpoints: {
        640: {
    ...
    initSwiperSafe(".whySwiper-home", {
      ...
      pagination: {
        el: ".whySwiper-home .swiper-pagination",
        clickable: true,
      },
      breakpoints: {
        640: {
  ...
  function initGsapAnimations() {
    ...
    var revealContainers = document.querySelectorAll(
      ".rs-container-reveal"
    );
    ...
    if (typeof SplitType !== "undefined") {
      document
        .querySelectorAll(".split-brand-title")
        .forEach(function (t) {
          new SplitType(t, {
            types: "words,chars",
            tagName: "span",
  ...
  function initRsEmailIndustriesShowcaseAnimations() {
    ...
    document
      ...
      .forEach(function (section) {
        ...
        const cardGrid = section.querySelector(
          ".industry-card-grid"
        );
  ...
  function initRsGdIntroAnimations() {
    ...
    jQuery(".rs-gd-intro").each(function () {
      ...
      $section
        .find(".rs-gd-intro__reveal")
        .each(function (paragraphIndex) {
          var paragraph = this;

          var words = jQuery(paragraph)
            .text()
            .trim()
            .split(/\s+/);
          ...
          var wordElements = paragraph.querySelectorAll(
            ".rs-gd-intro__word"
          );
      ...
      var copy = $section.find(
        ".rs-gd-intro__copy"
      )[0];

      var shape = $section.find(
        ".rs-gd-intro__shape"
      )[0];
    ...
    jQuery(".rs-vertical-cards").each(function () {
      ...
      jQuery(section)
        ...
        .each(function (index) {
          ...
          var speed =
            parseFloat(
              card.getAttribute("data-scroll-speed")
            ) || 1;
  ...
  function initSpecialImageChange() {
    var rsItems = document.querySelectorAll(
      ".rs-special-item"
    );

    var rsPreviewImage =
      document.getElementById("rsPreviewImage");

    var rsImageBox =
      document.getElementById("rsImageBox");
    ...
    function changeSpecialImage(item) {
      ...
      if (
        rsPreviewImage.getAttribute("src") ===
        newImage
      ) {
        return;
      }
      ...
      setTimeout(function () {
        rsPreviewImage.setAttribute(
          "src",
          newImage
        );

        rsImageBox.classList.remove(
          "rs-changing"
        );
      }, 220);
    }
    ...
    jQuery(".rs-vertical-cards").each(function () {
      ...
      jQuery(section)
        ...
        .each(function (index) {
          ...
          var speed =
            parseFloat(card.getAttribute("data-scroll-speed")) || 1;
          ...
          gsap.fromTo(
            ...
            },
            {
              y: function () {
                var distance =
                  window.innerHeight + card.offsetHeight + 630;

                var mobileFactor =
                  window.innerWidth < 768 ? 0.78 : 1;
      ...
      ScrollTrigger.create({
        ...
        onUpdate: function (self) {
          gsap.to(
            jQuery(section).find(".rs-vertical-cards__word"),
            {
              opacity: 0.34 + self.progress * 0.66,
              duration: 0.18,
              overwrite: true,
  ...
  function initSpecialImageChange() {
    var rsItems =
      document.querySelectorAll(".rs-special-item");
