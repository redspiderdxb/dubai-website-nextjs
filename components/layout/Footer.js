...
export default function Footer() {
  ...
  const services = [
    ...
    { name: "Brochure Designing", path: "#" },
    { name: "Graphic Designing", path: "#" },
    { name: "E-commerce Development", path: "#" },
    { name: "Email Marketing", path: "#" },
    { name: "Web Hosting", path: "#" },
    { name: "Logo Designing", path: "#" },
  ...
  return (
    <>
      <footer
        className="rs-footer-sec py-5 dark-background"
        style={{ overflow: "hidden" }}
      >
        <div
          className="container"
          style={{ maxWidth: "1600px", padding: "0 20px" }}
        >
          {/* Top Row */}
          <div className="row align-items-start gy-5">
            ...
            >
              ...
              >
                Power up your website <br /> with{" "}
                <span style={{ color: "#e31e24" }}>our experts</span>
              </h2>
              <Image
          ...
          {/* Bottom Row */}
          <div
            className="row rs-footer-bottom align-items-end border-0"
            style={{
              marginTop: "60px",
              paddingTop: "30px",
      ...
      >
        ...
        >
          <svg
            viewBox="0 0 24 24"
            style={{ width: "28px", height: "28px", fill: "#fff" }}
          >
