...
export default function Header() {
  ...
  const navItems = [
    ...
    { name: "Our Portfolio", path: "/portfolio" },
    {
      ...
      type: "dropdown",
      items: [
        { name: "Real Estate Web Design Company", path: "/real-estate-portal" },
        { name: "SMS Marketing UAE", path: "/sms-marketing-uae" },
        { name: "Daily Deal Website", path: "/daily-deal-website" },
        { name: "Dubizzle Clone", path: "/classified-directory" },
      ],
    },
