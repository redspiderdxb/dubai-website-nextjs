  ...
  return (
    <>
          ...
          <div className="row gx-xl-5 align-items-start">
            <div className="col-lg-3">
              <div className="rs-gd-intro__rail">
                <span className="rs-gd-intro__rail-icon"><i className="bi bi-bezier2"></i></span>
                <span className="rs-gd-intro__rail-text">{data.intro_small_heading || "Email Marketing · Dubai"}</span>
              </div>
            </div>
            <div className="col-lg-7">
              <div className="rs-gd-intro__copy">
                <p className="rs-gd-intro__lead rs-gd-intro__reveal">
                  {data.intro_description || "At RedSpider, we are proud to offer the best email marketing services in Dubai, that do more than just filling the inboxes. Whether you are launching a new product or promoting a seasonal offer, well designed email marketing can help you keep connected with your existing customers."}
                </p>
                <p className="rs-gd-intro__support rs-gd-intro__reveal">
                  Our team combines strategy and data driven optimization to help businesses in Dubai. Each campaign is designed to meet your business goals and send across your message to the right people at the right time.
                </p>
      ...
      <section className="archidex-accordion-sec dark-cs-bg dark-background dev-before">
        ...
        <div className="container rs-container-reveal" style={{ maxWidth: "1550px" }}>
          <div className="rs-container-reveal-inner">
            <div className="row g-5 align-items-start justify-content-between">
              <div className="col-lg-5">
                <h2 className="rs-main-title text-white fw-bold">Types of Email Campaigns We Manage</h2>
                <p className="text-white">We create email campaigns that are designed keeping in mind your business goals and customer interests.</p>
                <div className="accordion rs-studio-list" id={`studio-${data.id}`}>
                  {campaignTypes.map((campaign, index) => (
                    <div className="accordion-item rs-studio-item" key={index}>
                      <h3 className="accordion-header">
                        ...
                        >
                          <span className="rs-studio-symbol">{index === 0 ? "−" : "+"}</span>
                      ...
                      >
                        <div className="accordion-body rs-studio-body">{campaign.desc}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="col-lg-2 rs-studio-image-col">
                <div className="rs-studio-image-wrap">
                  {[1,2,3,4,5,6].map((i) => (
                    <img
                      key={i}
                      className={`rs-studio-img ${i === 1 ? "active" : ""}`}
                      src={`https://images.unsplash.com/photo-${["1497366754035-f200968a6e72","1517048676732-d65bc937f952","1556761175-b413da4baf72","1497366811353-6870744d04b2","1552664730-d307ca884978","1556761175-4b46a572b786"][i-1]}?q=80&w=1400&auto=format&fit=crop`}
                      alt="Email Marketing"
                    />
                  ))}
                </div>
              ...
              <div className="col-lg-5 px-lg-5">
                <div className="archidex-small-title mb-3 text-white">
                  <h6 className="text-white">Our <br />Email Marketing <br /> Process</h6>
                </div>
                <p className="text-white">Each campaign is thoroughly planned, professionally delivered and continually improved to deliver better results through a structured process.</p>
                <div className="accordion archidex-accordion mt-4" id={`process-${data.id}`}>
                  {data.processes?.map((process, index) => {
                    const isFirst = index === 0;
                    const collapseId = `collapse-${data.id}-${index}`;
                    return (
                      <div className="accordion-item" key={process.id || index}>
                        <h2 className="accordion-header">
                          <button
                            ...
                            type="button"
                            onClick={() => {
                              document.querySelectorAll(`#process-${data.id} .accordion-collapse`).forEach(el => el.classList.remove("show"));
                              document.querySelectorAll(`#process-${data.id} .accordion-button`).forEach(el => {
                              ...
                              if (target) {
                                ...
                                const btn = document.querySelector(`button[data-target="#${collapseId}"]`);
                        ...
                        <div id={collapseId} className={`accordion-collapse collapse ${isFirst ? "show" : ""}`}>
                          <div className="accordion-body">{process.description}</div>
                        </div>
                      </div>
                    );
                  })}
      ...
      {/* Platforms */}
      <section className="rs-ecommerce-platforms py-0 emailmark-camp" id="ecommerce-platforms">
        <div className="team-sticky">
          <div className="title-wrap text-center">
            <h2 className="title mb-4"><span className="red">Email Marketing</span> Platforms We Work With</h2>
            <p className="rs-subtitl introline mb-5">
              We collaborate with top email marketing services providers to provide businesses of all sizes with reliable, scalable and data-driven email marketing campaigns. We work with:
            </p>
          </div>
          <div className="gallery" aria-label="Email platforms">
            {platforms.map((platform, index) => (
              <article className="card" key={index}>
                <div className="card-content">
                  <span className="card-number">{String(index + 1).padStart(2, "0")}</span>
                  <div className="platform-icon" aria-hidden="true">
                    <img src={`/assets/img/icons/${platform.icon}.svg`} alt={platform.name} style={{ width: "60px" }} />
                  </div>
                  <h3>{platform.name}</h3>
                </div>
              </article>
          ...
          <p className="fs-3 text-center py-5 fw-bold rs-main-title" style={{ maxWidth: "960px", margin: "auto", lineHeight: "1.3" }}>
            You can also connect email marketing to your CRM, ecommerce store, or business management system for smooth communication with your customers.
          </p>
        </div>
      </section>
      ...
      <section className="email-industries-showcase">
        <div className="container position-relative" style={{ maxWidth: "1550px" }}>
          <div className="row g-4 g-xl-5 align-items-start">
            <div className="col-lg-4">
              <div className="email-industries-intro">
                <div className="email-industries-eyebrow"><span></span>Email marketing solutions</div>
                <h2 className="email-industries-title">Industries<br />We Serve</h2>
                <p className="email-industries-description">
                  With its ability to reach customers, boost engagement, and foster long-term growth, email marketing is an asset to any business, regardless of the industry. We offer email marketing services to:
                </p>
                <div className="email-visual" aria-hidden="true">
                  <div className="email-mini-stat"><strong>12</strong><span>Industries<br />and growing</span></div>
                  <div className="email-orbit">
                    <span className="email-dot email-dot-one"></span>
                    <span className="email-dot email-dot-two"></span>
                    <div className="email-icon-large"><i className="bi bi-envelope-paper"></i></div>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-lg-8">
              <div className="row g-3 industry-card-grid">
                {industries.map((industry, index) => (
                  <div className={`col-sm-6`} key={index}>
                    <div className={`industry-card ${[0,5,8].includes(index) ? "industry-card-accent" : ""}`}>
              ...
              <div className="industries-closing">
                <span className="closing-arrow"><i className="bi bi-arrow-up-right"></i></span>
                <p className="closing-text">Whatever your industry, we develop campaigns which match your company targets and customer needs.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row align-items-center g-5 w-100">
              <div className="col-lg-2">
                <div className="rs-mail-tech__index">
                  <p className="rs-mail-tech__category">Professional Email Marketing<br />Benefits &amp; Growth</p>
                </div>
              </div>
              <div className="col-lg-5">
                <div className="rs-mail-tech__content">
                  <h2 className="rs-mail-tech__title">Benefits of Professional <span>Email Marketing</span></h2>
                  <p className="rs-mail-tech__description">RedSpider helps businesses reach the right audiences with relevant content, personalized communication, intelligent automation and measurable campaign insights.</p>
                  <a className="rs-mail-tech__button" href="#rs-mail-benefit-list">
                ...
                <ul id="rs-mail-benefit-list" className="rs-mail-tech__specs">
                  {benefits.map((benefit, index) => (
                    <li className="rs-mail-tech__spec" key={index}>
                      <span className="rs-mail-tech__spec-label">Benefit {String(index + 1).padStart(2, "0")}</span>
      ...
      <section className="rs-mail-services-editorial">
        ...
        <div className="container mse-container">
          <div className="row g-4 mse-topbar">
            ...
            <div className="col-md-6 col-lg-3">
              <div className="mse-top-image">
                <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=900&q=85" alt="Email campaign analytics" />
              </div>
            </div>
            <div className="col-lg-6">
              <div className="mse-stat">
                <div className="mse-icon-stack" aria-hidden="true">
                  <span className="mse-icon-circle"><i className="bi bi-lightbulb"></i></span>
                  <span className="mse-icon-circle"><i className="bi bi-envelope-paper"></i></span>
                  <span className="mse-icon-circle"><i className="bi bi-graph-up-arrow"></i></span>
                </div>
                <div>
                  <p className="mse-stat-number"><span className="mse-count">13</span></p>
          ...
          <div className="row g-4 mse-hero">
            <div className="col-lg-8">
              <h2 className="mse-title">
                <span className="mse-title-line"><span className="mse-title-inner">Email</span></span>
                <span className="mse-title-line"><span className="mse-title-inner">Marketing</span></span>
                <span className="mse-title-line"><span className="mse-title-inner">Services</span></span>
              </h2>
            </div>
            <div className="col-lg-4">
              <div className="mse-copy">
                <span className="mse-copy-mark"></span>
                <p>Each company has a distinct objective, target audience and communication approach. That is why we develop customized email marketing strategies designed specifically for your industry and objectives.</p>
                <p className="mb-0">We offer the following email marketing services:</p>
              </div>
            </div>
          </div>
          ...
          <div className="row g-0 mse-services">
            {emailServices.map((service, index) => (
              <div className="col-md-6 col-lg-4" key={index}>
                <a className="mse-service" href={`#service-${String(index + 1).padStart(2, "0")}`}>
                  <span className="mse-service-number">{String(index + 1).padStart(2, "0")}</span>
                  <span className="mse-service-name">{service}</span>
                  <span className="mse-service-arrow"><i className="bi bi-arrow-right"></i></span>
                </a>
              </div>
            ))}
          </div>
          ...
          <div className="row mse-footer-row">
            <div className="col-sm-4"><span className="mse-wordmark">Email Focused</span></div>
            ...
            <div className="col-sm-4"><i className="bi bi-stars mse-spark" aria-hidden="true"></i></div>
          </div>
        </div>
      </section>
      ...
      <section className="rs-email-roi-showcase">
        <div className="ers-floating-email-bg" aria-hidden="true">
          <svg viewBox="0 0 120 120" width="200" height="200" role="presentation" aria-hidden="true" style={{ fill: "none", stroke: "currentColor", strokeWidth: "1.35", strokeLinecap: "round", strokeLinejoin: "round" }}>
        ...
        <div className="container ers-container">
          <div className="row align-items-start g-5">
            <div className="col-12">
              <div className="text-center" style={{ maxWidth: "860px", margin: "auto" }}>
                <div className="ers-kicker">Email Marketing ROI</div>
                <h2 className="ers-title">Why Email Marketing Still Delivers <span>Outstanding ROI</span></h2>
                <p className="ers-intro">Email marketing ranks among the highest-performing digital marketing channels because it gives direct access to customers who are already interested in your products and services. Instead of relying only on paid advertising, it remains an affordable option for every brand.</p>
              </div>
            </div>
            <div className="col-lg-7">
                ...
                {roiBenefits.map((benefit, index) => (
                  ...
                  >
                    <span className="ers-benefit-label">
                      <span className="ers-number">{String(index + 1).padStart(2, "0")}.</span> {benefit}
                    </span>
                    <span className="ers-arrow"><i className="bi bi-arrow-up-right"></i></span>
                  </li>
                ))}
              </ul>
            </div>
            <div className="col-lg-5">
              <div className="ers-visual">
                ...
                <div className="ers-image-card">
                  <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=1200&q=85" alt="Email marketing customer engagement" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="rs-agency-intro-sec">
        <div className="container">
          <h2 className="rs-agency-big-title text-white">Why Choose <span className="text-red">RedSpider</span> for Email Marketing in Dubai?</h2>
          <div className="row rs-agency-bottom align-items-center">
            ...
            <div className="col-lg-4">
              <p className="rs-agency-text fs-4 text-white">RedSpider is the preferred choice of businesses due to our ability to provide:</p>
            </div>
            <div className="col-lg-1 d-none d-lg-block"><div className="rs-agency-line"></div></div>
            <div className="col-lg-1">
              <div className="rs-agency-circle-wrap">
                <div className="rs-agency-scroll-text" id="rsAgencyCircleText"></div>
        ...
        <div className="rs-feature-marquee pb-0 pt-4">
            ...
            <div className="rs-feature-track">
              {whyChooseItems.map((item, index) => (
                <div className="rs-feature-item" key={index}>
                  <i className={`bi bi-${["person-workspace","palette","search","phone","shield-check","person-workspace"][index % 6]}`}></i>
                  <span>{item}</span>
                </div>
              ))}
            </div>
          ...
          <div className="rs-feature-row reverse">
            <div className="rs-feature-track">
              {whyChooseItems.map((item, index) => (
                <div className="rs-feature-item" key={index + whyChooseItems.length}>
                  <i className={`bi bi-${["person-workspace","palette","search","phone","shield-check","person-workspace"][index % 6]}`}></i>
                  <span>{item}</span>
                </div>
              ))}
      ...
      {/* Get A Quote */}
      <section className="rs-packages-se dark-background section pt-5 pb-0" style={{ background: "#fff" }}>
        <div className="container" style={{ maxWidth: "1450px" }}>
          <div className="row">
            <div className="col-12">
              <div className="rs-left-card h-100 d-flex flex-column flex-lg-row align-items-center justify-content-between gap-4 text-center text-lg-start">
                <div className="d-flex flex-column flex-md-row align-items-center justify-content-center gap-3 gap-md-4 gap-lg-5">
                  ...
                  <h4 className="mb-0">
                    Get an Estimate for Email <br className="d-none d-md-block" />
                    Marketing Services in Dubai
                  </h4>
                  <div className="rs-arrow-btn">
                    <span><img src="/assets/img/arrow-icon-40.svg" alt="" className="arrow-40deg-icon" /></span>
                  </div>
                </div>
            ...
            <p className="text-dark mt-2">
              <em>Are you starting out your first email campaign or want to improve your current strategy? With RedSpider you can achieve measurable results. Contact us today for a customized email marketing solution and grow your brand!</em>
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Review */}
      <section id="review-sec" className="review-sec section light-background py-5">
      ...
      {/* FAQs */}
      {data.faqs?.length > 0 && (
        <section id="rs-faq-sec" className="home-faq rs-faq-sec section pb-5 pt-0 light-background">
          <div className="container" style={{ maxWidth: "1600px", background: "#f6f6f6", padding: "40px", borderRadius: "30px" }}>
            <div className="text-start mb-5 border-bottom pb-3">
              <h2 className="fw-bold">Frequently Asked Questions</h2>
              <p>Find quick answers to common questions about email marketing.</p>
            </div>
            <div className="row g-4">
              <div className="col-lg-6">
                <div className="accordion" id={`faqLeft-${data.id}`}>
                  {data.faqs.slice(0, Math.ceil(data.faqs.length / 2)).map((faq, idx) => (
                    <div className="accordion-item" key={faq.id}>
                      <h2 className="accordion-header">
                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target={`#faq-${data.id}-left-${idx}`}>
                          {faq.question}
                        </button>
                      </h2>
                      <div id={`faq-${data.id}-left-${idx}`} className="accordion-collapse collapse" data-bs-parent={`#faqLeft-${data.id}`}>
              ...
              <div className="col-lg-6">
                <div className="accordion" id={`faqRight-${data.id}`}>
                  {data.faqs.slice(Math.ceil(data.faqs.length / 2)).map((faq, idx) => (
                    <div className="accordion-item" key={faq.id}>
                      <h2 className="accordion-header">
                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target={`#faq-${data.id}-right-${idx}`}>
                          {faq.question}
                        </button>
                      </h2>
                      <div id={`faq-${data.id}-right-${idx}`} className="accordion-collapse collapse" data-bs-parent={`#faqRight-${data.id}`}>
                        <div className="accordion-body">{faq.answer}</div>
                      </div>
                    </div>
                  ))}
