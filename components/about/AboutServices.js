      ...
      <div className="container" style={{ maxWidth: "1600px" }}>
        <div className="row g-5 align-items-start">
          <div className="col-lg-4 sticky-lg-top process-sticky">
            <h2 className="fs-1 fw-bold">Digital Products and Solutions</h2>
            <p>
              We offer a wide range of digital products and solutions for every
              business. Here is what you can get:
            </p>
