    ...
    <section id="readytobuild" className="readytobuild section light-background">
      ...
      <div className="container" style={{ maxWidth: '1100px' }}>
        <div className="inlinebtns text-center d-flex flex-column flex-md-row gap-3 align-items-center justify-content-center">
          <a href="our-portfolio" className="btn btn-animation btn-red d-inline-flex align-items-center justify-content-center gap-3 w-100 w-md-auto">
            <span className="btn-title">View Portfolio</span>
          </a>
          <a href="contactus.html" className="btn btn-animation btn-black d-inline-flex align-items-center justify-content-center gap-3 w-100 w-md-auto">
