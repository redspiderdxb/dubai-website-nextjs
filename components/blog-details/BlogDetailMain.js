        ...
        <div className="container">
          ...
          <div id="comment-1" className="comment">
            <div className="d-flex">
              ...
              <div>
                <h5>
                  <span>Georgia Reader</span>
                  <a href="#" className="reply">
                    <i className="bi bi-reply-fill" aria-hidden="true"></i>{" "}
                    Reply
                  </a>
                </h5>
