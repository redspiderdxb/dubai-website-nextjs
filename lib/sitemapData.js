  ...
  return {
    ...
    services: dedupeLinks([
      ...
      ),
      {
        ...
        href: "/service/seo-agency-dubai/",
        external: false,
      },
      {
        label: "Social Media Agency Dubai",
        href: "/social-media-agency-in-dubai/",
        external: false,
      },
      {
        label: "Web Design Sharjah",
        href: "/web-design-sharjah/",
        external: false,
      },
      {
        label: "Website Design Company JLT Dubai",
        href: "/website-design-company-jlt-dubai/",
        external: false,
      },
      {
        label: "Web Design Abu Dhabi",
        href: "/web-design-abu-dhabi/",
        external: false,
      },
    ]),
